...
public class GameController{
	...
	public GameController(Wheels wheels, Display screen, String[] compNames, int[] anIDs, String defaultScheme, double holdTime, double[] baseData){
		compID = new ComponentList(compNames);
		anID = new AnalogID(anIDs);
		this.screen = screen;
		numEvents = 0;
		numAnalogEvents = 0;
	...
	public void updateWheels(){
		contSys.update(comps[anID.LX].getPollData(), 
						comps[anID.LY].getPollData(), 
						comps[anID.RX].getPollData(), 
						comps[anID.RY].getPollData(), 
						comps[anID.Z].getPollData(), 
						comps[anID.HAT].getPollData());
	}
